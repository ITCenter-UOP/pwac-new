            ...
            <div className="flex flex-col md:flex-row items-center justify-between px-4 md:px-10 py-3 gap-3 md:gap-0">
                ...
                <div className="relative" ref={dropdownRef}>
                    <motion.button
                        ...
                        className="flex items-center gap-3 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm px-2 py-1 md:px-3 md:py-1.5 transition-all border border-fuchsia-200/30 shadow-sm"
                    >
