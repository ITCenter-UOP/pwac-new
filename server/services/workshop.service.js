...
class WorkshopService {
    ...
    static async GetOneWorkshop(workshopId){
        const getonewokrshop = await Workshop.findById(workshopId)
        return GetOneWorkshopsResDTO(getonewokrshop)
    }
}
